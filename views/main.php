<div class="container-fluid">
    <div class="row slider">
        <section class="col-xs-12">
            ...
            <img class="slider__img" src="views/img/img-slider.png" alt="O-o-o-ops....">
        </section>
    </div>
</div>
<div class="container">
    <section class="row hot-dial">
        <div class="col-md-6">
            <div class="hot-dial__item">
                ...
                <img class="hot-dial__img" src="views/img/hot-dial-item1.png" alt="">
            </div>
            <div class="hot-dial__item">
                <header class="hot-dial__header">
                ...
                <img class="hot-dial__img hot-dial__img_low" src="views/img/hot-dial-item3.png" alt="">
            </div>
        </div>
        <div class="col-md-6">
            <div class="hot-dial__item">
                ...
                <img class="hot-dial__img hot-dial__img_low" src="views/img/hot-dial-item2.png" alt="">
            </div>
            <div class="hot-dial__item">
                <header class="hot-dial__header">
                ...
                <img class="hot-dial__img" src="views/img/hot-dial-item4.png" alt="">
            </div>
        </div>
    </section>
    <div class="row">
    ...
    <div class="row">
        <div class="col-md-3">
            <div class="featured__item">
                <img src="views/img/featured-item1.png" alt="" class="featured__img">
            ...
            <div class="featured__item">
                <img src="views/img/featured-item5.png" alt="" class="featured__img">
                <div class="featured__description">Mango People T-Shirt</div>
                <div class="featured__description featured__description_cost highlight">$52.00</div>
            </div>
        </div>
        <div class="col-md-3">
            <div class="featured__item">
                <img src="views/img/featured-item2.png" alt="" class="featured__img">
                <div class="featured__description">Mango People T-Shirt</div>
                <div class="featured__description featured__description_cost highlight">$52.00</div>
            </div>
            <div class="featured__item">
                <img src="views/img/featured-item6.png" alt="" class="featured__img">
                <div class="featured__description">Mango People T-Shirt</div>
                <div class="featured__description featured__description_cost highlight">$52.00</div>
            </div>
        </div>
        <div class="col-md-3">
            <div>
                <img src="views/img/featured-item3.png" alt="" class="featured__img">
                <div class="featured__description">Mango People T-Shirt</div>
                <div class="featured__description featured__description_cost highlight">$52.00</div>
            </div>
            <div class="featured__item">
                <img src="views/img/featured-item7.png" alt="" class="featured__img">
                <div class="featured__description">Mango People T-Shirt</div>
                <div class="featured__description featured__description_cost highlight">$52.00</div>
            </div>
        </div>
        <div class="col-md-3">
            <div class="featured__item">
                <img src="views/img/featured-item4.png" alt="" class="featured__img">
                <div class="featured__description">Mango People T-Shirt</div>
                <div class="featured__description featured__description_cost highlight">$52.00</div>
            </div>
            <div class="featured__item">
                <img src="views/img/featured-item8.png" alt="" class="featured__img">
                <div class="featured__description">Mango People T-Shirt</div>
                <div class="featured__description featured__description_cost highlight">$52.00</div>
            </div>
        </div>
    ...
    <section class="row banner">
        <div class="col-md-8">
            <img class="banner__img" src="views/img/banner.png" alt="A Young Girl... ">
        </div>
        <div class="col-md-4 banner__info">
            <div class="banner__info-item">
                <div class="col-md-3">
                    <img class="banner__info-item-icon" src="views/img/icon-delivery.png" alt="">
                </div>
                <div class="col-md-9">
            ...
            <div class="banner__info-item">
                <div class="col-md-3">
                    <img class="banner__info-item-icon" src="views/img/icon-sales.png" alt="">
                </div>
                <div class="col-md-9">
            ...
            <div class="banner__info-item">
                <div class="col-md-3">
                    <img class="banner__info-item-icon" src="views/img/icon-quality.png" alt="">
                </div>
                <div class="col-md-9">
...
<div class="container-fluide">
    <section class="row subscribe-bottom">
        <div class="col-md-6 subscribe-bottom__info">
            <div class="row">
                <div class="col-md-5">
                    <img class="subscribe-bottom__info-person-photo" src="views/img/subscribe-bottom-person.png"
                         alt="It's me!">
                </div>
